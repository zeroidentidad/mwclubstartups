...
//
$registros_array = $registros->select_contactos($conn, $anio, $estado, "", $profesion);

$total_registros = $registros->numeroRegistrosReporte($conn, $anio, $estado, "", $profesion);
			...
			<page_header>
				<table class="page_header">
					<tr>
						...
						<?php } else if($tr=='3'){ ?>
							<h2><u><?php print $profesion_array["nombre"] ?></u>&nbsp;-&nbsp;REGISTROS&nbsp;<u><?php print $anio; ?></u>&nbsp;-&nbsp;<u><?php print 'N° '.$estado; ?></u></h2>
						<?php } ?>	
						</td>
					</tr>
				</table>
