...
//
$registros_array = $registros->select_contactos($conn, $anio, $estado, "", "");

$total_registros = $registros->numeroRegistrosReporte($conn, $anio, $estado, "", "");
				...
				<table class="page_header">
					<tr>
						<td style="width: 100%; text-align: center;">
							<h1>REGISTROS&nbsp;<u><?php print $anio; ?></u>&nbsp;-&nbsp;<u><?php print 'N° '.$estado; ?></u></h1>
						</td>
					</tr>
				</table>
			</page_header>
